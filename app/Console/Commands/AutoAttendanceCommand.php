    ...
    public function handle()
    {
        ...
        foreach ($users as $user) {
            try {
                ...
                // CRITICAL FIX: Check if parentUserId exists and has auto_attendence enabled
                ...
                $attendance = Attendance::create([
                    ...
                    'processed_by' => 1 // System/admin user ID
                ]);
                
                $markedCount++;
                $this->info("Auto-marked attendance for user {$user->id} - Status: {$status}");
